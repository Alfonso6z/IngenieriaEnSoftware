...
<html> 
  <head>
    <title>Deselecci'on Participantes</title>
...
<body>
  <div class="jumbotron">
    ...
    <?php } ?>
    <h3 class = "text-center"><strong>Remover participantes</strong></h3><br>
    ...
    <h5 class = "text-center "><?= form_submit('','Remover',"class='btn btn-danger'")?>
      <?= form_close() ?> 
    </h5>
  </div>
