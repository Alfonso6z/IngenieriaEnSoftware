      ...
      <?php } ?>
        <h3 class = "text-center"><?=  form_label(' Modificar Usuario ');?>
          ...
          <div  class = "text-center">
            ...
            <h4 class = "text-center"><?=  form_label('Usuario: ','nombre') ?>
              <?= form_input($nombre) ?>
            </h4>
            <h4 class="text-center"> <?=  form_label('Apellido: ','apellido') ?>
              <?= form_input($apellido) ?>
            </h4>  
            <div style="width: 101.5%"><h4 class = "text-center"><?=  form_label('Em@il: ','email') ?>
              <?= form_input($email) ?></h4>
            </div>           
            <div class = "text-center">
              <h4>
