...
-- Tiempo de generación: 29-11-2018 a las 02:07:02
...
ALTER TABLE `asignarestudio`
  ...
  ADD CONSTRAINT `asignarestudio_ibfk_3` FOREIGN KEY (`idCuestionario`) REFERENCES `cuestionarios` (`idCuestionario`) ON UPDATE CASCADE;
